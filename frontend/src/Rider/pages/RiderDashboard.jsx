        ...
        <div className="min-h-screen bg-background pb-20">
            <div className="p-4 pt-6 sticky top-0 bg-background/80 backdrop-blur-xl border-b border-border z-10">
                <div className="flex justify-between items-center mb-4">
                    <div>
                        ...
                        <p className="text-xs text-muted-foreground">Thursday, 12 Dec</p>
                    </div>
                    <button
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                    <div className="p-3 bg-gradient-to-br from-accent to-accent/50 rounded-xl border border-border relative overflow-hidden">
                        ...
                        <p className="text-xs text-muted-foreground font-medium uppercase mb-1">Earnings</p>
                ...
                <div className="flex space-x-2 overflow-x-auto pb-1 no-scrollbar">
                    {['all', 'assigned', 'picked_up', 'delivered'].map(status => (
                        <button
                            key={status}
            ...
            <div className="p-4 space-y-2">
                {loading && orders.length === 0 ? (
                    <div className="py-20 text-center text-sm text-muted-foreground animate-pulse">Loading orders...</div>
                    ...
                    <div className="py-20 text-center flex flex-col items-center">
                        ...
                        <p className="text-muted-foreground text-sm">Try changing filters</p>
                    </div>
                )}
            </div>
        </div>
