    ...
    return (
        ...
        >
            <div className="flex justify-between items-start mb-3">
                ...
                <span className={cn("px-2.5 py-1 rounded-full text-[10px] font-medium uppercase tracking-wider border", statusStyles[order.status])}>
            ...
            <div className="space-y-2 mb-4 pl-1">
                <div className="flex items-center px-2 py-1.5 rounded-lg bg-background/50 border border-transparent group-hover:border-border/50 transition-colors">
                    ...
                    <p className="text-sm text-muted-foreground truncate">{order.restaurant.address}</p>
                </div>
                <div className="flex items-center px-2 py-1.5 rounded-lg bg-background/50 border border-transparent group-hover:border-border/50 transition-colors">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-500 mr-3" />
                    <p className="text-sm text-muted-foreground truncate">{order.customer.address}</p>
                </div>
            </div>
